...
namespace WebTest.Page
{
    public partial class Pager : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            query.Join<Member>((a, b) => a.UserId == b.Id).SelectField((a, b) => new { a.ProductName, b.Name });//筛选返回的字段
            query.Join<Order>((a, b) => a.UserId == b.UserId).SelectField((a, b) => new { orderid = b.OrderId });//筛选返回的字段
