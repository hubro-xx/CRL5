...
namespace WebTest
{
    public partial class Query2 : System.Web.UI.Page
    {
        ...
        protected void Button6_Click(object sender, EventArgs e)
        {
            ...
            //SUM
            //按条件id>0,合计Number列
            var sum = ProductDataManage.Instance.Sum(b => b.Id > 0, b => b.Number * b.UserId);
            //按条件id>0,进行总计
            var count = ProductDataManage.Instance.Count(b => b.Id > 0);
            var max = ProductDataManage.Instance.Max(b => b.Id > 0, b => b.Id);
            var min = ProductDataManage.Instance.Min(b => b.Id > 0, b => b.Id);
        }
        ...
        protected void Button7_Click(object sender, EventArgs e)
        {
            ...
            //GROUP条件
            query.GroupBy(b => new { b.BarCode, b.ProductName }).GroupHaving(b => b.Number.SUM() >= 0);
            //设置排序
        ...
        protected void Button8_Click(object sender, EventArgs e)
        {
            var query = ProductDataManage.Instance.GetLambdaQuery();
            query.Where(b => b.Id > 0);
            var view = query.Select(b => new { distinct = b.ProductName.DistinctField() });
            ...
            foreach (var item in list)
            {
                var str = string.Format("{0}______<br>", item.distinct);//动态对象
                Response.Write(str);
            }
        }
    }
