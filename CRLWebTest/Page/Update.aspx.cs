...
namespace WebTest
{
    public partial class Update : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            ProductDataManage.Instance.Update(b => b.Id == 4, c);
            //按匿名对象
            ProductDataManage.Instance.Update(b => b.Id == 4, new { ProductName = "product1" });
            ...
            ProductDataManage.Instance.Update(b => b.Id == 4, p);//指定查询更新

            //当对象是查询创建则能自动识别
            p = ProductDataManage.Instance.QueryItem(b => b.Id > 0);
            p.UserId += 1;//只会更新UserId
            p.ProductName = "2342342";
            ProductDataManage.Instance.Update(p);//按主键更新,主键值是必须的

            //使用完整查询关联更新
            var query = OrderManage.Instance.GetLambdaQuery();
            ...
            OrderManage.Instance.Update(query, c);
