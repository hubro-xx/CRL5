...
namespace WebTest
{
    public partial class Cache : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            var item = ProductDataManage.Instance.QueryItemFromCache(5);
            var list = ProductDataManage.Instance.QueryFromCache(b => b.Id < 10);
        }

        protected void Button3_Click(object sender, EventArgs e)
        {
            var list = ProductDataManage.Instance.AllCache;//指定一个数据源
            ...
            #region 优化后查找 只需一次
            var query = new CRL.ExpressionJoin<ProductData>(list, b => b.Id > 0);
            if (a)
            {
